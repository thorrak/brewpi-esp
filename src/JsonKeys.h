...
constexpr auto kpHeat = "KpHeat";
constexpr auto kiHeat = "KiHeat";
constexpr auto kdHeat = "KdHeat";
constexpr auto pidMaxHeat = "pidMaxHeat";
};
...
/**
 * \brief Strings used for JSON keys
 * \see GlycolLearnedParams, GlycolConfig
 */
